...
describe('Check Catigories undo delete command handlers', () => {
  ...
  it(`"${cmd_undo_archctg}" should be rejected without arguments`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg,
        toBeMessage: generateInvInstruction(
          TrKey.INVALID_UNDO_ARCH_CTG_CMD,
  ...
  const cmd_undo_archctg_amb = `${cmd_undo_archctg} categoryTitle ...`;
  it(`"${cmd_undo_archctg_amb}" should be rejected as of too many arguments`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg,
        toBeMessage: generateInvInstruction(
  ...
  const cmd_undo_archctg_fake_ctg = `${cmd_undo_archctg} ${fakeCtgTitle}`;
  it(`"${cmd_undo_archctg_fake_ctg}" should be rejected as of not existing archived category`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_fake_ctg,
        prepareDB: async () => {
  ...
  it(`"${cmd_undo_archctg_fake_ctg}" should be rejected as of already active category with the same name`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_fake_ctg,
        prepareDB: async () => {
  ...
  it(`"${cmd_undo_archctg_fake_ctg}" should be rejected as of already active subcategory with the same name`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_fake_ctg,
        prepareDB: async () => {
  ...
  const cmd_undo_archctg_real_sbc = `${cmd_undo_archctg} ${realCtgTitle}`;
  it(`"${cmd_undo_archctg_real_sbc}" should be resolved as restored from archived category and connected subcategories and notes`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_real_sbc,
        prepareDB: async () => {
          serverNowDate = parseUserDateTimeToUTC(
            '2019.04.09 12:00',
            config.test.user_time_zone,
        ...
        toBeMessage: (_, { dbSbc1, dbSbc2, dbNote1, dbNote2 }) =>
          new ToTranslate(
            TrKey.CTG_UNDO_ARCHIVED_WITH_SBC_AND_NT,
            userLangCode,
            {
              title: realCtgTitle,
  ...
  const cmd_undo_archctg_real_ctg2 = `${cmd_undo_archctg} ${realCtgTitle2}`;
  it(`"${cmd_undo_archctg_real_ctg2}" should be resolved as restored from archived category and connected subcategories`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_real_ctg2,
        prepareDB: async () => {
          serverNowDate = parseUserDateTimeToUTC(
            '2019.04.09 12:00',
            config.test.user_time_zone,
        ...
        toBeMessage: (_, { dbSbc1, dbSbc2 }) =>
          new ToTranslate(TrKey.CTG_UNDO_ARCHIVED_WITH_SBC, userLangCode, {
            title: realCtgTitle2,
            sbcTitles: printSbcTitles([dbSbc1, dbSbc2]),
          }),
      },
  ...
  it(`"${cmd_undo_archctg_real_ctg}" should be resolved as restored from archived category and connected notes`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_real_ctg,
        prepareDB: async () => {
        ...
        toBeMessage: (_, { dbNote2 }) =>
          new ToTranslate(TrKey.CTG_UNDO_ARCHIVED_WITH_NT, userLangCode, {
            title: realCtgTitle,
  ...
  const cmd_undo_archctg_amb_title = `${cmd_undo_archctg} ${realCtgTitle} [${CommandParameterName.ctgTitle}${PARAMS_EQ}${realCtgTitle}]`;
  it(`"${cmd_undo_archctg_amb_title}" should be rejected as of title parameter and text at the same time`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_amb_title,
        prepareDB: async () => {
          await appBotMock.db.notes.deleteAll({
            table_peer_id: chatId,
            peer_id: chatId,
  ...
  const cmd_undo_archctg_amb_id = `${cmd_undo_archctg} ${realCtgTitle} [${CommandParameterName.ctgId}${PARAMS_EQ}123]`;
  it(`"${cmd_undo_archctg_amb_id}" should be rejected as of id parameter and text at the same time`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_amb_id,
        toBeMessage: new ToTranslate(
          TrKey.PARAM_AMBIGUOUS_ERROR,
          userLangCode,
          {
  ...
  const cmd_undo_archctg_unreal_param_id = `${cmd_undo_archctg} 223 [${CommandParameterName.ctgId}${PARAMS_EQ}123]`;
  it(`"${cmd_undo_archctg_unreal_param_id}" should be rejected as of id parameter and text-number at the same time`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_unreal_param_id,
        toBeMessage: new ToTranslate(
          TrKey.PARAM_AMBIGUOUS_ERROR,
          userLangCode,
          {
  ...
  const cmd_undo_archctg_by_fake_id = `${cmd_undo_archctg} [${CommandParameterName.ctgId}${PARAMS_EQ}${fakeCtgId}]`;
  it(`"${cmd_undo_archctg_by_fake_id}" should be rejected as of not existing category by id parameter`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archctg_by_fake_id,
        prepareDB: async () => {
          await appBotMock.db.notes.deleteAll({
            table_peer_id: chatId,
            peer_id: chatId,
  ...
  it(`"${cmd_undo_archctg} [${CommandParameterName.ctgId}${PARAMS_EQ}id]" should be resolved as restored from deleted category by id parameter`, () =>
    testBotMsgsRes([
      {
        prepareDB: async () => {
          await appBotMock.db.notes.deleteAll({
        ...
        toSendText: (_, { dbCtg }: { dbCtg: CategoryDBModel }) =>
          `${cmd_undo_archctg} [${CommandParameterName.ctgId}${PARAMS_EQ}${dbCtg.id}]`,
        toBeMessage: (_) => {
          const ret = _[0].preparedData;
          return new ToTranslate(TrKey.CTG_UNDO_ARCHIVED, userLangCode, {
