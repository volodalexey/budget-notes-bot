...
describe('Check subcategories undo archive command handlers', () => {
  ...
  it(`"${cmd_undo_archsbc}" should be rejected without arguments`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc,
        toBeMessage: generateInvInstruction(
          TrKey.INVALID_UNDO_ARCH_SBC_CMD,
  ...
  const cmd_undo_archsbc_amb = `${cmd_undo_archsbc} sbcTitle ...`;
  it(`"${cmd_undo_archsbc_amb}" should be rejected as of too many arguments`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_amb,
        toBeMessage: generateInvInstruction(
          TrKey.INVALID_UNDO_ARCH_SBC_CMD,
          BotCommandEnum.undoarchsbc,
          userLangCode,
  ...
  const cmd_undo_archsbc_fake_sbc = `${cmd_undo_archsbc} ${fakeSbcTitle}`;
  const realCtgTitle = 'realCtgTitle';
  const realSbcTitle = '⛔';
  it(`"${cmd_undo_archsbc_fake_sbc}" should be rejected as of not existing subcategory`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_fake_sbc,
        prepareDB: async () => {
  ...
  it(`"${cmd_undo_archsbc_fake_sbc}" should be rejected as of already active category with the same name`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_fake_sbc,
        prepareDB: async () => {
  ...
  it(`"${cmd_undo_archsbc_fake_sbc}" should be rejected as of already active subcategory with the same name`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_fake_sbc,
        prepareDB: async () => {
  ...
  it(`"${cmd_undo_archsbc_real_sbc}" should be resolved as restored from archived subcategory with notes`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_real_sbc,
        prepareDB: async () => {
        ...
        toBeMessage: (_, { dbNote2, dbNote3 }) =>
          new ToTranslate(TrKey.SBC_UNDO_ARCHIVED_WITH_NT, userLangCode, {
            title: realSbcTitle,
  ...
  const cmd_undo_archsbc_amb_title = `${cmd_undo_archsbc} ${realSbcTitle} [${CommandParameterName.sbcTitle}${PARAMS_EQ}${realSbcTitle}]`;
  it(`"${cmd_undo_archsbc_amb_title}" should be rejected as of title parameter and text at the same time`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_amb_title,
        prepareDB: async () => {
  ...
  const cmd_undo_archsbc_amb_id = `${cmd_undo_archsbc} ${realSbcTitle} [${CommandParameterName.sbcId}${PARAMS_EQ}123]`;
  it(`"${cmd_undo_archsbc_amb_id}" should be rejected as of id parameter and text at the same time`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_amb_id,
        toBeMessage: new ToTranslate(
          TrKey.PARAM_AMBIGUOUS_ERROR,
          userLangCode,
          {
  ...
  const cmd_undo_archsbc_unreal_param_id = `${cmd_undo_archsbc} 223 [${CommandParameterName.sbcId}${PARAMS_EQ}123]`;
  it(`"${cmd_undo_archsbc_unreal_param_id}" should be rejected as of id parameter and text-number at the same time`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_unreal_param_id,
        toBeMessage: new ToTranslate(
          TrKey.PARAM_AMBIGUOUS_ERROR,
          userLangCode,
          {
  ...
  const cmd_undo_archsbc_by_fake_id = `${cmd_undo_archsbc} [${CommandParameterName.sbcId}${PARAMS_EQ}${fakeSbcId}]`;
  it(`"${cmd_undo_archsbc_by_fake_id}" should be rejected as of not existing category by id parameter`, () =>
    testBotMsgsRes([
      {
        toSendText: cmd_undo_archsbc_by_fake_id,
        prepareDB: async () => {
          await appBotMock.db.notes.deleteAll({
            table_peer_id: chatId,
            peer_id: chatId,
  ...
  it(`"${cmd_undo_archsbc} [${CommandParameterName.sbcId}${PARAMS_EQ}id]" should be resolved as restored from archived subcategory by id parameter`, () =>
    testBotMsgsRes([
      {
        prepareDB: async () => {
          await appBotMock.db.notes.deleteAll({
        ...
        toSendText: (_, { dbSbc }: { dbSbc: SubcategoryDBModel }) =>
          `${cmd_undo_archsbc} [${CommandParameterName.sbcId}${PARAMS_EQ}${dbSbc.id}]`,
        toBeMessage: (_) => {
          const ret = _[0].preparedData;
          return new ToTranslate(TrKey.SBC_UNDO_ARCHIVED, userLangCode, {
